...
interactive("hackernews-next-post",
    ...
    function (I) {
        var next_post = hackernews_next_item(I, _hackernews_post_filter, 1 /* down */, "current");
        hackernews_focus_post(I, next_post);
    });

interactive("hackernews-prev-post",
    "Select the previous post.",
    function (I) {
        var prev_post = hackernews_next_item(I, _hackernews_post_filter, -1 /* up */, "current");
        hackernews_focus_post(I, prev_post);
    });
...
interactive("hackernews-next-comment",
    ...
    function (I) {
        var next_comment = hackernews_next_item(I, _hackernews_comment_filter, 1 /* down */, "current-comment");
        hackernews_focus_comment(I, next_comment);
    });

interactive("hackernews-prev-comment",
    "Focus previous Hacker News comment",
    function (I) {
        var prev_comment = hackernews_next_item(I, _hackernews_comment_filter, -1 /* down */, "current-comment");
        hackernews_focus_comment(I, prev_comment);
    });
